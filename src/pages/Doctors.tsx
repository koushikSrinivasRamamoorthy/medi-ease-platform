...
import { Stethoscope, MessageCircle, Clock, MapPin } from "lucide-react";
  ...
  return (
    <>
      <SEO
        ...
        keywords="doctors Mayiladuthurai, SVR Clinic doctors, Sri Vaitheswara Clinic physicians, specialist doctors Tamil Nadu, ENT doctor Mayiladuthurai, cardiologist Mayiladuthurai, pediatrician Mayiladuthurai"
      />
      <div className="min-h-screen bg-background">
        ...
        <main className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <header>
                <h1 className="text-4xl md:text-5xl font-bold mb-6">
                  Meet Our Expert Doctors in 
                  <span className="text-primary"> Mayiladuthurai</span>
                </h1>
              </header>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Our team of highly qualified medical professionals at SVR Clinic is dedicated to providing you with the best healthcare experience in Mayiladuthurai, Tamil Nadu.
              </p>
            </div>
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-start text-sm">
                          <Clock className="h-4 w-4 mr-2 mt-0.5 flex-shrink-0 text-muted-foreground" />
            ...
            {/* CTA Section */}
            <div className="text-center bg-secondary/30 rounded-lg p-8 mt-16">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Need Medical Consultation?
              </h2>
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Contact SVR Clinic in Mayiladuthurai, Tamil Nadu to discuss your healthcare needs 
                and we'll connect you with the right medical specialist.
              </p>
